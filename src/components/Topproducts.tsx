    ...
    <div className="min-h-fit">
      <div className="p-2 lg:px-10 sm:px-5 pb-6 grid grid-cols-1   sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 gap-3">
        {Topproducts.map((product, index) => (
          ...
          >
            <img
              className="w-full lg:h-[600px] hover:cursor-pointer sm:h-[500px] "
              src={product.img_url}
              alt="adidas"
            />
            ...
            <div className="justify-center flex divide-x-2 divide-gray-400 gap-3">
              <button
                className="py-2 w-full flex justify-center transition ease-in-out items-center hover:drop-shadow-lg hover:bg-black hover:text-white "
                title="Add to Cart"
              >
                Buy Now
              </button>

          ...
          Topproducts.map((product, index) =>
            <div className=" bg-white overflow-hidden hover:shadow-2xl " key={index}>
              ...
              <div className="justify-center flex divide-x-2 divide-gray-400 gap-3">
                <button className="py-2 w-full flex justify-center transition ease-in-out items-center hover:drop-shadow-lg hover:bg-black hover:text-white " title='Add to Cart'>Buy Now</button>  
              </div>
            </div>
          )
        }
